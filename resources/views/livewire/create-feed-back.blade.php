            ...
            @if ($currentStep == 2)
                ...
                <div class="card-body p-0">
                    ...
                    <div class="qset">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="option2" id="optionnine" checked>
                            <label class="form-check-label" for="optionnine">
                                Poor
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="option2" id="optionten" checked>
                    ...
                    <div class="qset">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="option3" id="optiontwelve" checked>
